  ...
  return (
    ...
    >
      ...
      {isDragOver ? (
        ...
        <>
          <div className="text-[#e6edf3] font-semibold text-base mb-1">Drop media files here</div>
          <div className="text-[#8b949e] text-sm mb-4">or click to browse</div>
        </>
      )}

      <div className="flex flex-wrap gap-1.5 justify-center max-w-sm">
        {['MP4', 'MKV', 'MOV', 'WebM', 'MP3', 'AAC', 'FLAC', 'WAV', 'ProRes', 'AVI', 'MXF'].map(
          (f) => (
            <span
              key={f}
